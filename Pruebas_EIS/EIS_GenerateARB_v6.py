...
cycles, points_per_cycle =RP7972A.cycles_per_frequency(frequency)
print(cycles)
points, dwell_time = RP7972A.arb_data(RP7972A,frequency , points_per_cycle)
print((points*amplitude)+amplitude)
messages = ["FUNC CURR, (@1)",
            "VOLT:LIM 10",
            "ABOR:TRAN (@1)",
            ...
            "CURR:MODE ARB,(@1)",
            "TRIG:ARB:SOUR Bus",
            "ARB:CURR:CDW:DWELL "+str(dwell_time)+",(@1)",
            "CURR:SLEW INF"]################################slew rate setting
for mess in messages:
    inst.scpi_out(mess)


inst.scpi_points_out((points*amplitude)+amplitude)
